use super::lp_verifier_constants::{N_PUBLIC_INPUTS, ic, precomputed_lines, vk};

#[starknet::interface]
pub trait ILPVerifier<TContractState> {
...
mod LPVerifier {
    ...
    #[abi(embed_v0)]
    impl ILPVerifier of super::ILPVerifier<ContractState> {
        fn verify_groth16_proof_bn254(
