...
pub trait ISwapVerifier<TContractState> {
    fn verify_groth16_proof_bn254(
        self: @TContractState, proof_with_hints: Span<felt252>,
...
mod SwapVerifier {
    ...
    impl ISwapVerifier of super::ISwapVerifier<ContractState> {
        fn verify_groth16_proof_bn254(
            self: @ContractState, proof_with_hints: Span<felt252>,
        ) -> Result<Span<u256>, felt252> {
            let fph = deserialize_full_proof_with_hints_bn254(proof_with_hints);
